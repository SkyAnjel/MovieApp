...
import com.example.movieapp.databinding.FragmentWatchedBinding;
...
public class WatchedFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater in,@Nullable ViewGroup c, @Nullable Bundle s){
        binding = FragmentWatchedBinding.inflate(in,c,false);
    ...
    private void loadMovies(String status){
        ...
        if(ids.isEmpty()){
            adapter.setMovieList(new ArrayList<>());   // покажем пусто
            return;
        }
